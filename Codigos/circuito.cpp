...
void pedirDatos()
{
    cout << "Ingrese los vlores de las resistencias 1-10 separados por espacio: ";
    cin >> r1 >> r2 >> r3 >> r4 >> r5 >> r6 >> r7 >> r8 >> r9 >> r10;
    cout << endl;
    cout << "Ingrese los valores de voltaje v1,v2 v3 separados por espacio: ";
    cin >> v1 >> v2 >> v3;
    nfilas = 5;
    ncols = nfilas;
    ...
    //garantizar una matriz de ceros
    for(int i=0; i<nfilas; i++){
    ...
    matriz[0][0] = r1+r2+r3; matriz[0][1] = -r2; matriz[0][2] = -r3;
    matriz[1][0] = -r2; matriz[1][1] = r10+r2+r4+r5; matriz[1][2] = -r4;
    matriz[1][3] = -r5; matriz[1][4] = -r10;
    matriz[2][0] = -r3; matriz[2][1] = -r4;
    matriz[2][2] = r6+r4+r3; matriz[2][3] = -r6;
    matriz[3][1] = -r5; matriz[3][2] = -r6;
    matriz[3][3] = r8+r7+r6+r5; matriz[3][4] = -r7;
    matriz[4][1] = -r10; matriz[4][3] = -r7;
    matriz[4][4] = r9+r10+r7;
    datos[0] = v1;
    datos[1] = 0;
    datos[2] = -v2;
    datos[3] = -v3;
